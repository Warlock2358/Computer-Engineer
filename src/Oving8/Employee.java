...
public class Employee {
    ...
    /**
     * Method to calculate the amount of tax the employee has to pay
     *
    ...
    public double getYearlyTaxPayed() {
        return (getTaxPayed() * 10) + (getTaxPayed() * 0.5); //Calculates the yearly tax payed by the employee
    }
    ...
    /**
     * Method to check if the employee has been employed for more than a set amount of years
